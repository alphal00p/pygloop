    ...
    if fmass != 0.0:
        ...
        if pp == 0.0:
            ...
            if pp3 == 0.0:
                ...
                chi1 = complex(nh * p[1] / sqrt(2.0 * pp * pp3), p[2] / sqrt(2.0 * pp * pp3))
    ...
    if vmass != 0.0:
        ...
        if pp == 0.0:
            ...
            if pt != 0.0:
                ...
                vc[3] = complex(hel0 * p[1] * emp - p[1] * pzpt, -nsvahl * p[2] / pt * sqh)
                vc[4] = complex(hel0 * p[2] * emp - p[2] * pzpt, nsvahl * p[1] / pt * sqh)
            else:
                vc[3] = complex(-nhel * sqh, 0.0)
    ...
    if nhel == 3:
        ...
        for i, j in product(list(range(4)), list(range(4))):
            if cond1:
                ...
                rc[(i, j)] = sq2 / sq3 * e0[i] * fip[j] + 1 / sq3 * ep[i] * fim[j] * complex(p[1], nsr * p[2]) / pt
    elif nhel == -1:
        for i, j in product(list(range(4)), list(range(4))):
            if cond1:
                ...
                rc[(i, j)] = 1 / sq3 * em[i] * fip[j] + sq2 / sq3 * e0[i] * fim[j] * complex(p[1], nsr * p[2]) / pt
    else:
        for i, j in product(list(range(4)), list(range(4))):
            if cond1:
                rc[(i, j)] = em[i] * fim[j]
    ...
    if nhel == 3:
        ...
        for i, j in product(list(range(4)), list(range(4))):
            if cond1:
                ...
                rc[(i, j)] = sq2 / sq3 * e0[i] * fop[j] + 1 / sq3 * ep[i] * fom[j] * complex(p[1], -nsr * p[2]) / pt
        ...
        for i, j in product(list(range(4)), list(range(4))):
            if cond1:
                ...
                rc[(i, j)] = 1 / sq3 * em[i] * fop[j] + sq2 / sq3 * e0[i] * fom[j] * complex(p[1], -nsr * p[2]) / pt
    else:
        for i, j in product(list(range(4)), list(range(4))):
            if cond1:
                rc[(i, j)] = em[i] * fom[j]
